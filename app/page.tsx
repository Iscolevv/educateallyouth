...
async function HomePageContent({
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section
        id="hero"
        className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-teal-50 via-blue-50 to-white overflow-hidden scroll-mt-20 pt-20"
      >
      ...
      {/* About Section */}
      <section id="about" className="py-16 md:py-24 bg-gradient-to-b from-white to-teal-50 scroll-mt-20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 text-center mb-6 text-balance">
            About EducateAll Youth Initiative
          </h2>
          ...
          <div className="mt-16 bg-gradient-to-r from-purple-600 via-blue-600 to-teal-600 rounded-2xl p-12 text-white shadow-xl max-w-5xl mx-auto">
      ...
      {/* Our Story Section */}
      <section id="story" className="py-16 md:py-24 bg-gradient-to-b from-teal-50 to-white scroll-mt-20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 text-center mb-6 text-balance">Our Story</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-teal-600 to-orange-500 mx-auto mb-12"></div>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    <span className="font-semibold text-teal-600">October 4th, 2021</span>, by Brian Onyango, driven by
                    a deep passion to promote academic equality across Kenya's western region, an area where many public
                    schools face significant resource challenges. What started as a small volunteer effort, mobilizing a
                    few individuals to mentor and support students, soon grew into a dynamic youth-led movement.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    <span className="font-semibold text-orange-600">nationwide platform</span>, empowering young people
                    across Kenya with the tools, guidance, and opportunities they need to succeed academically.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    into the lives we've touched, the communities we serve, and the possibilities that arise when people
                    come together to champion education. Inspired by the spirit of giving back, much like the ethos
                    celebrated by institutions such as{" "}
      ...
      <section id="gallery" className="py-16 md:py-24 bg-white scroll-mt-20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 text-center mb-4 text-balance">Gallery</h2>
      ...
      <section id="testimonials" className="py-16 md:py-24 bg-white scroll-mt-20">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-16 bg-gradient-to-r from-teal-600 to-blue-600 rounded-2xl p-12 text-white text-center shadow-xl max-w-5xl mx-auto">
      ...
      <section id="team" className="py-16 md:py-24 bg-white scroll-mt-20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 text-center mb-4 text-balance">Meet the Team</h2>
          ...
          {/* Desktop Grid */}
          <div className="hidden lg:grid grid-cols-1 xl:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {/* Brian Onyango Card */}
      ...
      <section id="contact" className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 text-balance">Get in Touch</h2>
      ...
      <section id="donate" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 text-balance">Support Our Mission</h2>
      ...
      {/* Scroll Animation Script - REMOVED */}
      {/* Removed the entire script block as per updates */}
...
// Changed export to default async function Home() as per updates
export default async function Home() {
  // This function now calls the HomePage function to get the data
  // and then renders the content.
  const {
    projects,
    testimonials,
    gallery, // Renamed galleryItems to gallery for consistency
    newsEvents,
    volunteerStories,
  } = await HomePage() // Await the result of HomePage()
